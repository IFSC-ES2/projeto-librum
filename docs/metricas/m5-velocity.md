...
| Sprint 5 | 14/06/2026     | 0 SP (histórias)       | Sprint de Release Candidate. Nenhuma história de produto nova: o backlog de US já havia fechado 100% na Sprint 4 (41 de 41 SP). O esforço foi todo de hardening e fechamento - feedback do mascote Tinta (carregamento e erros), contrato de erro do backend, testes de aceitação do MVP, fechamento das métricas pendentes e documentação do RC -, distribuído em 12 PRs, três blocos por integrante. Como não havia histórias a entregar, a velocity em SP de história é zero por definição; a medida não indica desvio, e sim a natureza de uma sprint de robustez e fechamento de RC. |
