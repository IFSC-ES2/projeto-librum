...
| Sprint 5 | 14/06/2026     | 0 SP (historias)       | Sprint de Release Candidate. Nenhuma historia de produto nova: o backlog de US ja havia fechado 100% na Sprint 4 (41 de 41 SP). O esforco foi todo de hardening e fechamento - feedback do mascote Tinta (carregamento e erros), contrato de erro do backend, testes de aceitacao do MVP, fechamento das metricas pendentes e documentacao do RC -, distribuido em 12 PRs, tres blocos por integrante. Como nao havia historias a entregar, a velocity em SP de historia e zero por definicao; a medida nao indica desvio, e sim a natureza de uma sprint de robustez e fechamento de RC. |
